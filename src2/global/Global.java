...
public class Global {
	...
	//donnees perso
	public static int persoChoisi = 1 ; //0 pour homme et 1 pour femme
			//public static String[] = {"Homme", "Femme"} ;
	public static double[] masse = {80, 65} ;
	public static double[] Cx = {1.2, 1.2} ;
	public static double[] surfaceTransversale = {(Math.pow(1.02, 2) + 2 * Math.pow(0.333, 2)) / (4 * Math.PI), (Math.pow(0.94, 2) + 2 * Math.pow(0.333, 2)) / (4 * Math.PI)} ;
	public static double[] surfaceFrontale = {0.95, 0.8} ;
	public static double[] longueurJambeRepos = {0.875, 0.815} ;
	...
	public static double[] raideur = {56138, 45298} ;
	...
	public static LinkedList<LinkedList<Plateforme > > listePlateformes  = new LinkedList<LinkedList<Plateforme > >() ;
	public static LinkedList<LinkedList<PlateformeG>> listePlateformesG = new LinkedList<LinkedList<PlateformeG>>() ;
